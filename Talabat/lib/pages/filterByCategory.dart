...
class Filterbycategory extends StatefulWidget {  
  ...
  const Filterbycategory({super.key, required this.section_id});  
  

  @override  
  State<StatefulWidget> createState() => _FilterbycategoryState();  
}  
...
// locale: languageCubit.state.isEnglish? 'en' : 'ar'
    try {  
      List<Product> newProducts =  
          await apiService.getProducts(page: page, sectionId: widget.section_id,);  
      print(newProducts);  
